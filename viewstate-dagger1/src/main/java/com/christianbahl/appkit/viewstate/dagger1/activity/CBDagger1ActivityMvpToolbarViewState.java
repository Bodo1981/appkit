 ...
 * Dagger 1 for dependency injection. It also adds a {@link Toolbar} on top.
 * </p>
 *
 * <p>
 ...
 * @see Dagger1MvpLceViewStateActivity
 */
public abstract class CBDagger1ActivityMvpToolbarViewState<CV extends View, D, V extends MvpLceView<D>, P extends MvpPresenter<V>>
    extends Dagger1MvpLceViewStateActivity<CV, D, V, P> {
