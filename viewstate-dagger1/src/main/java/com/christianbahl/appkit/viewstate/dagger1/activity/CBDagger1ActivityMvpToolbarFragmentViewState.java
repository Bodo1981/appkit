 ...
 * support and Dagger 1 for dependency injection.<br/>
 ...
 * @see CBDagger1ActivityMvpToolbarViewState
 */
public abstract class CBDagger1ActivityMvpToolbarFragmentViewState<CV extends View, D, V extends MvpLceView<D>, P extends MvpPresenter<V>>
    extends CBDagger1ActivityMvpToolbarViewState<CV, D, V, P> {
