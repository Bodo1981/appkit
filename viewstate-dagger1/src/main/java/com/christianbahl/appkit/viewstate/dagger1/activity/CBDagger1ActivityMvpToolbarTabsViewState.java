 ...
 */
package com.christianbahl.appkit.viewstate.dagger1.activity;
...
/**
 * <p>
 * An activity which uses the Model-View-Presenter architecture with {@link ViewState} support and
 * Dagger 1 for dependency injection. It also adds a {@link Toolbar} on top and has a {@link
 * ViewPager} with {@link TabLayout}.
 * </p>
 *
 * <p>
 ...
 */
public abstract class CBDagger1ActivityMvpToolbarTabsViewState<A extends PagerAdapter, D, V extends MvpLceView<D>, P extends MvpPresenter<V>>
    extends CBDagger1ActivityMvpToolbarViewState<ViewPager, D, V, P> {
