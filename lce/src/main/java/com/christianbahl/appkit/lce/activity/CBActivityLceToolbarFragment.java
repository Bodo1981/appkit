 ...
 */
public abstract class CBActivityLceToolbarFragment<CV extends View, M, V extends MvpLceView<M>, P extends MvpPresenter<V>>
    extends CBActivityLceToolbar<CV, M, V, P> {
