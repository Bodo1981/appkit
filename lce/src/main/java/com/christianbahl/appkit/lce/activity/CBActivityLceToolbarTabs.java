 ...
 * @see CBActivityLceToolbar
 */
public abstract class CBActivityLceToolbarTabs<M, V extends MvpLceView<M>, P extends MvpPresenter<V>, A extends PagerAdapter>
    extends CBActivityLceToolbar<ViewPager, M, V, P> {
