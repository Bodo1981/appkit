 ...
 */
public abstract class CBFragmentMvpRecyclerViewViewState<M, V : CBMvpView<M>, P : MvpPresenter<V>, A : CBAdapterRecyclerView<M>> : MvpLceViewStateFragment<RecyclerView, MutableList<M>, V, P>() {
